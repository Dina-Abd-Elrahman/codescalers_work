...
class PackagesTests(BaseTest):
    ...
    def test02_add_delete_package(self):
        ...
        **Test Scenario**
        ...
        installed_package = packages.check_package_card("installed")
        self.assertIn("notebooks", installed_package)
        ...
        available_packages = packages.check_package_card("available")
