...
class SshClient(BaseTest):
    ...
    def test017_execute_for_non_valid_command_line(self):
        """
        TC 493
        Test Case to test execute command in remote machine, should fail

        **Test scenario**
        #. use execute method to execute ( NON_VALID ) in remote machine, should fail with error
           ("Could not execute:%s" % command)
        """
        with self.assertRaises(Exception):
            self.SSH_CLIENT.execute(cmd="NON_VALID", interactive=False)

    def test018_execute_for_none(self):
        """
        TC 494
        Test Case to test execute command in remote machine, should fail

        **Test scenario**
        #. use execute method to execute (None) in remote machine, should fail, with error (cmd needs to be string).
        """
        with self.assertRaises(Exception):
            self.SSH_CLIENT.execute(cmd=None, interactive=False)

    @unittest.skip("https://github.com/threefoldtech/jumpscaleX_core/issues/160")
    def test019_execute_for_script(self):
        """
        TC 512
    ...
    @unittest.skip("https://github.com/threefoldtech/jumpscaleX_core/issues/160")
    def test020_ssh_authorize_with_pubkeys_option_specified_and_home_dir(self):
        """
        TC 495
    ...
    def test021_ssh_authorize_without_pubkeys_option_specified(self):
        """
        TC 496
    ...
    @unittest.skip("https://github.com/threefoldtech/jumpscaleX_core/issues/160")
    def test022_ssh_authorize_with_pubkeys_option_specified_with_non_valid_homedir(self):
        """
        TC 501
    ...
    def test023_portforward_to_local(self):
        """
        TC
    ...
    @unittest.skip("https://github.com/threefoldtech/jumpscaleX_core/issues/160")
    def test028_execute_jumpscale_for_valid_jsx_command(self):
        """
        TC
    ...
    @unittest.skip("https://github.com/threefoldtech/jumpscaleX_core/issues/160")
    def test029_execute_jumpscale_for_non_valid_jsx_command(self):
        """
        TC
